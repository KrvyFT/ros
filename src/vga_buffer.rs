...
impl ColorCode {
    fn new(fore: Color, back: Color) -> ColorCode {
...
impl ScreenChar {
    fn read(&self) -> ScreenChar {
        unsafe { return core::ptr::read_volatile(self) }
    }

    fn write(&mut self, src: ScreenChar) {
        unsafe { core::ptr::write_volatile(self, src) }
    }
}
